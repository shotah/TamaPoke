...
// TCA9554 @ 0x20: LCD_RST=EXIO2, TP_RST=EXIO1, SD CS=EXIO3.
// Included once from expander.cpp (TAMAPOKE_EXPANDER_H).
// Not named expander.h — display.h includes the API header expander.h
// and quoted includes search this folder first.

static uint8_t outBits = 0xFF;

...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  ...
  // ---------------- JA (romaji: font has no kana/kanji) ----------------
  {
    "Shinka-chu!", "Mogumogu!", "Suki!", "Onaka suita!", "Ofuro da yo!",
    "Tsukareta...", "Shonbori...", "Pokochato...", "SHINY da!!", "Ureshii",
    "ARIGATO! Sayonara", "Nigechatta...", "Ja ne!",
    "TAMAGO", "Densetsu no tamago!?", "Rare tamago!", "Tamago wo toto...", "Ugoku!", "Mousugu!",
    "ZUKAN %u/151",
    "%s%s Lv.%u",
    "%s wo hanasu?", "HAI", "IIE",
    "%u HIT", "ATK +%u", "NEW RECORD!", "BEST: %u", "HAYAKU!",
    "SCORE: %u", "Tanoshii!", "+ureshii",
    "JIKAN", "JI", "FUN", "ue: kyanseru", "Gengo",
    "MEDAL!", "SUGOI!", "%u NICHI!",
    "RENZOKU %u  best %u", "KIZUNA", "BERRY ???", "AKA BERRY", "AO BERRY", "MIDORI",
    "%s   AGE %lud", "namae: henko",
    "BATTLE", "ATK", "DEF", "SPD", "WGT", "ATK TRAIN",
    "MEDAL %d/%d", "tap: modoru",
    "NAMA:", "tap de modoru",
    "TABE", "JOY", "ENE", "SOUJI",
    "BEST %u",
    "SHINCHOKU", "Lv.%u", "%u fun de Lv.%u", "SHINKA", "Saishu kei",
    "Shinka OK!", "Minna 40 ijo de shinka",
    "%u lv de shinka", "Shippa: %u",
    "SND ON", "SND OFF",
    "SHINKA!", "%s ga hanashitai...", "%s sabishii...",
    "Shinka?", "Kono mama", "Sayonara?", "Sayonara", "Issho",
    "Starter wo erabe",
    "Sprite nashi", "SD ni irete",
    "Tamago kara.",
    "Sayonara ga tsugi wo shuku",
    "Sodate, shinka, sayonara.",
    "Tsugi wa atarashii tamago.",
    "DERU",
    "Byoki da!",
  },
  // ---------------- ZH (pinyin: font has no hanzi) ----------------
  {
    "Jinhua zhong!", "Xiang chi!", "Xi huan!", "E le!", "Yao xizao!",
    "Lei le...", "Nan guo...", "You dian pang...", "SHINY!!", "Kai xin",
    "XIE XIE! Zai jian", "Pao le...", "Zai jian!",
    "DAN", "Chuanqi dan!?", "Xiyou dan!", "Dian dan...", "Dong le!", "Kuai le!",
    "TUJIAN %u/151",
    "%s%s Lv.%u",
    "Fang %s?", "SHI", "FOU",
    "%u HIT", "ATK +%u", "NEW RECORD!", "BEST: %u", "KUAI DA!",
    "SCORE: %u", "Hao wan!", "+kaixin",
    "SHE ZHI SHI", "SHI", "FEN", "shang: quxiao", "Yuyan",
    "XUNZHANG!", "TAI BANG!", "%u TIAN!",
    "LIAN %u  best %u", "QIN", "GUO ???", "HONG GUO", "LAN GUO", "LV GUO",
    "%s   AGE %lud", "dian ming: gai",
    "ZHANDOU", "ATK", "DEF", "SPD", "WGT", "LIAN LI",
    "XUNZHANG %d/%d", "dian: fanhui",
    "MING:", "dian fanhui",
    "SHI", "LE", "ENE", "JIE",
    "BEST %u",
    "JINDU", "Lv.%u", "%u fen dao Lv.%u", "JINHUA", "Zhong xing",
    "Keyi jinhua!", "Quanbu 40 cai jinhua",
    "%u ji hou jinhua", "Shiwu: %u",
    "SND ON", "SND OFF",
    "JINHUA!", "%s xiang shuo...", "%s hen gudan...",
    "Jinhua?", "Bu bian", "Zai jian?", "Zai jian", "Liuzai",
    "Xuan chushi",
    "Meiyou tu", "Fang dao SD",
    "Cong dan fuhua.",
    "Zaijian zhufu xiage dan",
    "Yang, jinhua, zaijian.",
    "Xiage shi xin dan.",
    "TUI",
    "Bing le!",
...
static const char *const MED_NAME[LANG_COUNT][MED_COUNT] = {
  ...
  { "Lv.10", "Lv.25", "Lv.50", "BERRY", "7 RENZOKU", "KIZUNA", "SAISHU", "FIT" },
  { "Lv.10", "Lv.25", "Lv.50", "GUO", "7 TIAN", "QIN", "ZHONG", "FIT" },
};
static const char *const MED_LBL[LANG_COUNT][MED_COUNT] = {
  ...
  { "Lv10", "Lv25", "Lv50", "BERRY", "7HI", "KIZU", "SAI", "FIT" },
  { "Lv10", "Lv25", "Lv50", "GUO", "7TIAN", "QIN", "ZHONG", "FIT" },
};
static const char *const MED_DSC[LANG_COUNT][MED_COUNT] = {
  ...
  { "LEVEL 10", "LEVEL 25", "LEVEL 50", "BERRY MITSUKE",
    "7 NICHI", "KIZUNA MAX", "SAISHU KEI", "FIT" },
  { "LEVEL 10", "LEVEL 25", "LEVEL 50", "GUO ZHAO DAO",
    "7 TIAN", "QIN MAX", "ZHONG XING", "FIT" },
};
